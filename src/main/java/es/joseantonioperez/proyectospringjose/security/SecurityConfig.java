package es.joseantonioperez.proyectospringjose.security;
...
public class SecurityConfig {
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOrigins(List.of("http://localhost:5173","https://super-liga-lol.netlify.app", "hhttp://localhost" )); // Cambia esto al origen correcto
